...
const navigation = [
  { name: "Destinations", to: { name: "adminDestinations" } },
  { name: "Tours", to: { name: "adminTours" } },
  { name: "Bookings", to: { name: "adminBookings" } },
  { name: "Tickets", to: { name: "adminTickets" } },
  { name: "Users", to: { name: "adminUsers" } },
];
